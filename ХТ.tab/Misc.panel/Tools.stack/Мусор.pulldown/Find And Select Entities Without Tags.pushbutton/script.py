...
options = {
    ...
    'Электрические приборы': Taggable(
        tag_type=DB.BuiltInCategory.OST_ElectricalFixtureTags,
        element_type=DB.BuiltInCategory.OST_ElectricalFixtures
        ),

    'Воздуховоды': Taggable(
        tag_type=DB.BuiltInCategory.OST_MultiCategoryTags,
        element_type=DB.BuiltInCategory.OST_DuctCurves
        ),

    'Соединительные детали воздуховодов': Taggable(
        tag_type=DB.BuiltInCategory.OST_MultiCategoryTags,
        element_type=DB.BuiltInCategory.OST_DuctFitting
        ),
}
